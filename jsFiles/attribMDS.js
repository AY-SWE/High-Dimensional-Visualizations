...
svg
  ...
  .attr("y", 50)
  .attr("font-size", "24px")
  .text("MDS display of attributes");

d3.csv("./data/attributeMDSplotFinalized.csv").then(function (data) {
  ...
  g.append("g") //group element for x-axis title
    ...
    .attr("font-size", "14px")
    .attr("stroke", "red")
    .text("Coordinate 0"); //adds x-axis header
  ...
  g.append("g") //group element for y-axis title
    ...
    .attr("stroke", "red")
    .text("Coordinate 1"); //y-axis title stays the same for all attributes
